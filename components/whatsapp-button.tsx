...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group hidden md:grid fixed bottom-[calc(var(--mobile-bottom-nav-space)+22px)] right-[22px] z-[75] h-[58px] w-[58px] place-items-center rounded-full bg-[#34b442] text-white shadow-[0_16px_36px_rgba(0,0,0,0.22),0_0_0_5px_rgba(52,180,66,0.12)] ring-1 ring-white/25 transition duration-300 ease-luxe hover:-translate-y-0.5 hover:scale-105 hover:bg-[#42c750] hover:shadow-[0_20px_42px_rgba(0,0,0,0.26),0_0_0_7px_rgba(52,180,66,0.14)] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-gold/65 lg:bottom-[24px]"
    >
